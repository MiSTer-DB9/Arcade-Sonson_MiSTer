...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Sonson_MiSTer.git"
CORE_NAME=(Arcade-Sonson)
...
UPSTREAM_CORE_NAME=(Arcade-Sonson)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Sonson.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Sonson.rbf)
